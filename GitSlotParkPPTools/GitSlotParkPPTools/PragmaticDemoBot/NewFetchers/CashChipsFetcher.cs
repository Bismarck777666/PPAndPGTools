...
{
    internal class CashChipsFetcher : EuroNoWinRespinFetcher
    {
        private int[] _freeSpinCounts = new int[] { 0, 0 };
        public CashChipsFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
