...
{
    class PowerOfMerlinMegawaysFetcher : GameSpinDataFetcher
    {
        private int[] _freeSpinTypeCounts = new int[] { 0, 1000, 1000, 1000, 1000, 1000};
        public PowerOfMerlinMegawaysFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
