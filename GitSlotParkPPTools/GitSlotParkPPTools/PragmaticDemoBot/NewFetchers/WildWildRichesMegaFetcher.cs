...
{
    class WildWildRichesMegaFetcher : GameSpinDataFetcher
    {
        private int[] _freeSpinTypeCounts = new int[] { 110, 110, 110, 110, 110, 0, 110, 110 };
        public WildWildRichesMegaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
        ...
        protected override int findFreeSpinType(SortedDictionary<string, string> dicParams)
        {
            ...
            string[]    strParts = strTrail.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries)[0].Split(new string[] { "~"}, StringSplitOptions.RemoveEmptyEntries);
