...
{
    class AztecGemsDeluxeFetcher : GameSpinDataFetcher
    {
        public AztecGemsDeluxeFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
