...
{
    class PizzaPizzaPizzaFetcher : GameSpinDataFetcher
    {
        public PizzaPizzaPizzaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
