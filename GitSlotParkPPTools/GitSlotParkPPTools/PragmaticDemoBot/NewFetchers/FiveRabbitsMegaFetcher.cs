...
{
    class FiveRabbitsMegaFetcher : GameSpinDataFetcher
    {
        public FiveRabbitsMegaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
