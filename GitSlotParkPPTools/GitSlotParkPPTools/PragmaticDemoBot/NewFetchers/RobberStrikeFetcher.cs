...
{
    class RobberStrikeFetcher : GameSpinDataFetcher
    {
        private int[] _freeSpinTypeCounts = new int[] {100, 0};
        public RobberStrikeFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet, bool isV4, bool isAsia = false) :
