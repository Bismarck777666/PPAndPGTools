...
{
    class YumYumPowerWaysFetcher : GameSpinDataFetcher
    {
        private int[] _freeSpinTypeCounts = new int[] { 100, 100, 100, 100, 0 };
        public YumYumPowerWaysFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
                ...
                do
                {
                    ...
                    else if (strNextAction == "b")
                    {
                        if (selectedFreeOption == -1)
                        {
                            ...
                            responseList.Add(response);
                            beforeFreeTotalWin = totalWin;
                            selectedFreeOption = selectFreeSpinType(0);
                        }
