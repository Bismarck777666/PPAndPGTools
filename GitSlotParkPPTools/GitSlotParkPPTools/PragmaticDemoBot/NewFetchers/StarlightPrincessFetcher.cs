...
{
    class StarlightPrincessFetcher : GameSpinDataFetcher
    {
        public StarlightPrincessFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
