...
{
    class SantaGreatGiftsFetcher : GameSpinDataFetcher
    {
        public SantaGreatGiftsFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
