...
{
    class MagicianSecretsFetcher : GameSpinDataFetcher
    {
        private int _lastFreeSpinType = 0;
        public MagicianSecretsFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
            ...
            try
            {
                ...
                do
                {
                    ...
                    else if (strNextAction == "b")
                    {
                        ...
                        int freeSpinOption = 1;// _lastFreeSpinType;
                        _lastFreeSpinType  = (_lastFreeSpinType + 1) % 2;
