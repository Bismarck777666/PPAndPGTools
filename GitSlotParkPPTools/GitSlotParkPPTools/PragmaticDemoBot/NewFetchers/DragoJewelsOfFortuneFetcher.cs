...
{
    class DragoJewelsOfFortuneFetcher :GameSpinDataFetcher
    {
        public DragoJewelsOfFortuneFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
