...
{
    class BonanzaGoldFetcher : GameSpinDataFetcher
    {
        public BonanzaGoldFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
