...
{
    class EuroGameFetcher : GameSpinDataFetcher
    {
        public EuroGameFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet, bool isV4) :
