...
{
    class PirateGoldDeluxFetcher : GameSpinDataFetcher
    {
        public PirateGoldDeluxFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
