...
{
    public class TheAmazingMoneyMachineFetcher : GameSpinDataFetcher
    {
        public TheAmazingMoneyMachineFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
        ...
        protected override bool isFreeOrBonus(SortedDictionary<string, string> dicParams)
        {
            ...
            return base.isFreeOrBonus(dicParams);
        }
