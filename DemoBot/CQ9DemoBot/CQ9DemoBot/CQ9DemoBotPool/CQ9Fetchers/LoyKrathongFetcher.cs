...
{
    public class LoyKrathongFetcher : Temble8Fetcher
    {
        private readonly ILoggingAdapter _logger = Logging.GetLogger(Context);
        public LoyKrathongFetcher(int proxyIndex, Config config) : base(proxyIndex, config)
        {
        }
        public static new Props Props(int proxyIndex, Config config)
        {
            return Akka.Actor.Props.Create(() => new LoyKrathongFetcher(proxyIndex, config));
        }
        ...
        {
            LoyKrathongTembleRequest requestParam = new LoyKrathongTembleRequest();
            requestParam.Type           = 3;
    ...
    public class LoyKrathongTembleRequest
    {
