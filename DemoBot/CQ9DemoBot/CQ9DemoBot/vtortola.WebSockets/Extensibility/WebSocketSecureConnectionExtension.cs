...
namespace vtortola.WebSockets
{
    public sealed class WebSocketSecureConnectionExtension : IWebSocketConnectionExtension
    {
        ...
        public Stream ExtendConnection(Stream stream)
        {
            ...
            ssl.AuthenticateAsServer(_certificate, _validation != null, SslProtocols.Default | SslProtocols.Tls12, false);
            return ssl;
        }
        ...
        {
            var ssl = new SslStream(stream, false, _validation);
            await ssl.AuthenticateAsServerAsync(_certificate, _validation != null, SslProtocols.Default | SslProtocols.Tls12, false).ConfigureAwait(false);
            return ssl;
        }
    }
}
