...
{
    class PeKingLuckFetcher : GameSpinDataFetcher
    {
        public PeKingLuckFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
