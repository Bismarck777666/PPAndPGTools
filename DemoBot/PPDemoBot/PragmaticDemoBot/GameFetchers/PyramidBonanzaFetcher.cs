...
{
    class PyramidBonanzaFetcher : GameSpinDataFetcher
    {
        public PyramidBonanzaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
