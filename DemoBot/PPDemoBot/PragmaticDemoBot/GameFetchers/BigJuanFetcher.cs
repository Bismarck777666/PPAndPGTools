...
{
    class BigJuanFetcher : GameSpinDataFetcher
    {
        public BigJuanFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
