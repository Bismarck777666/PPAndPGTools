...
{
    class WildWildBananasFetcher : GameSpinDataFetcher
    {
        public WildWildBananasFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
