...
{
    internal class SweetBonanzaFetcher : GameSpinDataFetcher
    {
        public SweetBonanzaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
