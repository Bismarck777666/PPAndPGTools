...
{
    class QueenOfGodsFetcher : GameSpinDataFetcher
    {
        private int _lastFreeSpinType = 0;
        public QueenOfGodsFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
            ...
            try
            {
                ...
                do
                {
                    ...
                    else if (strNextAction == "b")
                    {
                        ...
                        int freeSpinOption = _lastFreeSpinType;
                        _lastFreeSpinType = (_lastFreeSpinType + 1) % 4;
