...
{
    internal class VolcanoGoddessFetcher : EuroNoWinRespinFetcher
    {
        private int[] _freeSpinCounts = new int[] { 0, 0 };
        public VolcanoGoddessFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet, bool isV4) :
