...
{
    class LuckyFishingFetcher : GameSpinDataFetcher
    {
        private int[] _freeSpinTypeCounts = new int[] { 100,100,100,0};
        public LuckyFishingFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
