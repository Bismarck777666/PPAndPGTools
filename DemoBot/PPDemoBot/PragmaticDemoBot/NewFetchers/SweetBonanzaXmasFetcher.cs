...
{
    internal class SweetBonanzaXmasFetcher : GameSpinDataFetcher
    {
        public SweetBonanzaXmasFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
