...
{
    class BigBassMissionFishinFetcher : EuroNoWinRespinFetcher
    {
        private int[] _freeSpinTypeCounts = new int[] { 0, 0 };

        public BigBassMissionFishinFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet, bool isV4) :
