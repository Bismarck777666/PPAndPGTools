...
{
    class FuryOfOdinMegaFetcher : GameSpinDataFetcher
    {
        public FuryOfOdinMegaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
