...
{
    class GreatReefFetcher : GameSpinDataFetcher
    {
        public GreatReefFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
