...
{
    class KingdomOfTheDeadFetcher : GameSpinDataFetcher
    {
        private int[] _freeSpinTypeCounts = new int[2];

        public KingdomOfTheDeadFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
