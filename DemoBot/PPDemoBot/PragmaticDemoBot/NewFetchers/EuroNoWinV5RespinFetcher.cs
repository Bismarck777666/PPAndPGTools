...
{
    class EuroNoWinV5RespinFetcher : GameSpinDataFetcher
    {
        public EuroNoWinV5RespinFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet, bool isV5, bool isAsia = false) :
