...
{
    class VoodooMagicFetcher : GameSpinDataFetcher
    {
        public VoodooMagicFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
