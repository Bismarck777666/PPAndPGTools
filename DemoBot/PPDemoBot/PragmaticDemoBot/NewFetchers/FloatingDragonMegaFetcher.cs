...
{
    class FloatingDragonMegaFetcher : GameSpinDataFetcher
    {
        public FloatingDragonMegaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
