...
{
    class RomeoAndJulietFetcher : GameSpinDataFetcher
    {
        public RomeoAndJulietFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet) :
            ...
            try
            {
                ...
                do
                {
                    ...
                    else if (strNextAction == "s")
                    {
                        ...
                        if (strNextAction == "s" && !dicParamValues.ContainsKey("rs")
