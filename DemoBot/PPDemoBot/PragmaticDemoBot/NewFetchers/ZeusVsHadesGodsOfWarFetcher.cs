...
{
    class ZeusVsHadesGodsOfWarFetcher : GameSpinDataFetcher
    {
        public ZeusVsHadesGodsOfWarFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet, bool isV4) :
        ...
        protected KeyValuePair<string, string>[] buildDoPurSpinRequest(string strToken)
        {
            KeyValuePair<string, string>[] postValues = new KeyValuePair<string, string>[]
                    ...
                    new KeyValuePair<string, string>("pur",     "3"),
