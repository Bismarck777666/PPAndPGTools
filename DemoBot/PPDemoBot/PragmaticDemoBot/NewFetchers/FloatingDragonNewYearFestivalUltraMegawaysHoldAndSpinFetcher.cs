...
{
    class FloatingDragonNewYearFestivalUltraMegawaysHoldAndSpinFetcher : GameSpinDataFetcher
    {
        public FloatingDragonNewYearFestivalUltraMegawaysHoldAndSpinFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet) :
                base(strProxyInfo, strProxyUserID, strProxyPassword, strClientVersion, realBet, true)
        {
            _isV4 = true;
        }
        public void setV3False()
        {
            _isV3 = false;
        }
