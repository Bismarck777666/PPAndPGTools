...
{
    class WildWestGoldMegaFetcher : GameSpinDataFetcher
    {
        public WildWestGoldMegaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
