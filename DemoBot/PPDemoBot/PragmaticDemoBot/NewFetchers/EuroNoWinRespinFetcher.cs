...
{
    class EuroNoWinRespinFetcher : GameSpinDataFetcher
    {
        public EuroNoWinRespinFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet, bool isV4, bool isAsia = false) :
        ...
        protected virtual KeyValuePair<string, string>[] buildDoPurSpinRequest(string strToken)
        {
