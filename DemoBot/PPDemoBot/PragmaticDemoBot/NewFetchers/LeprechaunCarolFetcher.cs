...
{
    public class LeprechaunCarolFetcher : GameSpinDataFetcher
    {
        public LeprechaunCarolFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
                ...
                do
                {
                    ...
                    else if (strNextAction == "b")
                    {
                        if(dicParamValues.ContainsKey("status"))
                        {
                            ...
                            if (strParts.Length == 3 || strParts.Length == 5)
                            {
                                doBonusID = 0;
                            }
                            else
