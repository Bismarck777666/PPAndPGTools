...
{
    class SugarRushFetcher : GameSpinDataFetcher
    {
        public SugarRushFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
        ...
        protected override bool isFreeOrBonus(SortedDictionary<string, string> dicParams)
        {
            ...
            if (dicParams.ContainsKey("s_mark"))
                return true;
