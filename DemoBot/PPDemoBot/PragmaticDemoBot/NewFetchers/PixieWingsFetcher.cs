...
{
    class PixieWingsFetcher : GameSpinDataFetcher
    {
        private int[] _freeSpinTypeCounts = new int[] { 200, 200, 200, 200, 0};

        public PixieWingsFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
