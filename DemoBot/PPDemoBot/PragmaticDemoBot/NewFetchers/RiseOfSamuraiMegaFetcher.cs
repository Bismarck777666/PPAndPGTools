...
{
    class RiseOfSamuraiMegaFetcher : GameSpinDataFetcher
    {
        public RiseOfSamuraiMegaFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strClientVersion, double realBet, bool hasAnteBet) :
