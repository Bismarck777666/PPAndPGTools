...
{
    public class SpinDataFetcher_1 : SpinDataFetcher
    {
        public SpinDataFetcher_1(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strBrandGameId, string strClientVersion, double realBet, int lineCount, int betLevel, double stake, int coin)
        ...
        protected Habanero1GameState convertStringToGameState(string strState)
        {
            switch (strState)
            {
                case "main":
                    return Habanero1GameState.NormalSpin;
                case "freegame":
                    return Habanero1GameState.FreeSpin;
                case "symbolpick":
                    return Habanero1GameState.PickSymbol;
                case "chest":
                    return Habanero1GameState.Chest;
                case "pick":
                    return Habanero1GameState.Pick;
            }
            return Habanero1GameState.None;
        }
        protected string covertGameStateToString(Habanero1GameState gameState)
        {
            switch (gameState)
            {
                case Habanero1GameState.NormalSpin:
                    return "main";
                case Habanero1GameState.FreeSpin:
                    return "freegame";
                case Habanero1GameState.PickSymbol:
                    return "symbolpick";
                case Habanero1GameState.Chest:
                    return "chest";
                case Habanero1GameState.Pick:
                    return "pick";
            }
            return null;
        }
    ...
    public class KoiGateRequest: HabaneroRequest
    {
        public string portmessage { get; set; }
    }

    public enum Habanero1GameState
    {
        None        = 0,
        NormalSpin  = 1,
        FreeSpin    = 2,
