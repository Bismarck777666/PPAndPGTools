...
{
    public class OptionalSpinDataFetcher_1 : SpinDataFetcher_1
    {
        ...
        public OptionalSpinDataFetcher_1(string strProxyInfo, string strProxyUserID, string strProxyPassword,string strBrandGameId, string strClientVersion, double realBet,int lineCount,int betLevel,double stake,int coin,IList<int> freeOptions):
