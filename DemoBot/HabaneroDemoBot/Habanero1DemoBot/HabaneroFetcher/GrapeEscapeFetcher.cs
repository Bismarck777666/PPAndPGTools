...
{
    public class GrapeEscapeFetcher : SpinDataFetcher
    {
        public GrapeEscapeFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, string strBrandGameId, string strClientVersion, double realBet, int lineCount, int betLevel, double stake, int coin)
        ...
        protected async Task<string> sendPickRequest(HttpClient httpClient,string gameid,string gssid)
        {
            ...
            PayLoadGame["action"]           = "pickgamedone";
