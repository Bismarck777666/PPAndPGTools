...
{
    public class LuckyDurianProcess : SpinDBPreprocess
    {
        public LuckyDurianProcess(string strFolderName, string strGameName) : base(strFolderName, strGameName)
        {
