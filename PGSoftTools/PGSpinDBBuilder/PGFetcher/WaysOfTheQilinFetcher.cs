...
{
    class WaysOfTheQilinFetcher : PGSpinDataFetcher
    {
        public WaysOfTheQilinFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, int gameID, float betSize, int betLevel) :
