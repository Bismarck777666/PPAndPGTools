...
{
    class WildBountyShowdownFetcher : PGSpinDataFetcher
    {
        public WildBountyShowdownFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, int gameID, float betSize, int betLevel) :
