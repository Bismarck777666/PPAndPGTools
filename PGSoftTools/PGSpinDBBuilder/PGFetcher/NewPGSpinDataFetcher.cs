...
{
    internal class NewPGSpinDataFetcher : PGSpinDataFetcher
    {
        public NewPGSpinDataFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, int gameID, float betSize, int betLevel) :
