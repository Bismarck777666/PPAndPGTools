...
{
    class DinnerDelightsFetcher : PGSpinDataFetcher
    {
        public DinnerDelightsFetcher(string strProxyInfo, string strProxyUserID, string strProxyPassword, int gameID, float betSize, int betLevel) :
