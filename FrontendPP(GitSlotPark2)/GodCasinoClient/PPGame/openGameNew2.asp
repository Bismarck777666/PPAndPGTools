    ...
    <head>
        ...
        <script>
            ...
            Loader.LoadGame = function() {
                ...
                var script = Loader.LoadScript(UHT_CONFIG.GAME_URL + "bootstrap.js" + "?key=" + "ac196", Loader.LoadGameCallback, function() {
        ...
        <script type="text/javascript">
            <%
                Dim req_session, req_apiurl, req_symbol, req_supportreplay, req_title
            req_session = request("session")
            req_apiurl = request("apiurl")
            req_symbol = request("symbol")
            req_supportreplay = request("supportreplay")
            req_replayurl = request("replayurl")
            req_sessionkey2 = request("sessionkey2")
            req_lang = request("lang")
            req_currency = request("currency")
            req_title = request("gametitle")
            req_lobbyurl = request("lobbyurl")
            req_rsapublickey = request("RSAPublicKey")
            req_rsasessionkey = request("RSASessionKey")
                %>
var req_session = '<%=req_session%>';
            var req_apiurl = '<%=req_apiurl%>';
            var req_symbol = '<%=req_symbol%>';
            var req_supportreplay = '<%=req_supportreplay%>';
            var req_replayurl = '<%=req_replayurl%>';
            var req_sessionkey2 = '<%=req_sessionkey2%>';
            var req_lang = '<%=req_lang%>';
            var req_currency = '<%=req_currency%>';
            var req_title = "<%=req_title%>";
            var req_lobbyurl = '<%=req_lobbyurl%>';
            var req_rsapublickey = '<%=req_rsapublickey%>';
            var req_rsasessionkey = '<%=req_rsasessionkey%>';
            ...
            let configString = '{"instantFrbEnabled":false, "lobbyLaunched":false,"miniLobby":false,"jurisdiction":"99","openHistoryInWindow":false,"RELOAD_JACKPOT":"/gs2c/jackpot/reload.do","styleName":"agst_agst","SETTINGS":"/gitapi/pp/service/saveSettings.do","openHistoryInTab":false,"replayAPIURL":"' + paramAPIURL + '","environmentId":"13","historyType":"internal","vendor":"T","currency":"' + currency + '","lang":"' + req_lang + '","datapath":"' + dataURL + '/common/games-html5/games/vs/' + paramSymbol + '/","amountType":"COINS_V2","LOGOUT":"/gitapi/pp/service/logout.do","REGULATION":"https://agst-tw1.pragmaticplay.net/gs2c/regulation/process.do?symbol\u003d' + paramSession + '","showRealCash":"1","statisticsURL":"' + paramAPIURL + '/gitapi/pp/service/stats.do","accountType":"R","clock":"0","mgckey":"' + paramSession + '","gameService":"' + paramAPIURL + '/gitapi/pp/service/gameService","RELOAD_BALANCE":"/gitapi/pp/service/reloadBalance.do","currencyOriginal":"' + req_currency + '","extend_events":"1","sessionTimeout":"30","CLOSE_GAME":"/gs2c/closeGame.do?symbol\u003d' + paramSymbol + '","region":"Other","HISTORY":"' + baseURL + '/lastGameHistory?symbol\u003d' + paramSymbol + '\u0026mgckey\u003d' + paramSession + '\u0026lang\u003d' + req_lang + '","apiuri":"' + paramAPIURL + '"}';
            ...
            configObj["sessionKey"] = [
                "Y7kyJ71sVgaO7pG8pbonPPJOy3jhAKZ0cCt0pUJ1zmoOuQSZWXVwQfjBSUJw48iCRI5ucaFGpJLmk63FXpRBMg==",
                "4DHAFGT6kLL5D12oHykUbQ==",
                req_sessionkey2
            ];
            ...
            <svg id="logoOutContainer" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" version="1.1" viewBox="150 -400 900 1850" style="/* display: none; */">
                ...
                <g transform="translate(300 250) scale(0.5 0.5)">
                    <g transform="translate(900, 520)">
                        <g>
                            <animateTransform attributeName="transform" id="maskScaleAnimation" type="scale" begin="logoHide.end" fill="freeze" from="1 1" to="40 40" dur="0.8s" values="1 1; 1 1; 6 6; 12 12; 18 18; 24 24; 30 30; 45 40" keyTimes="0; 0.15; 0.3; 0.45; 0.6; 0.75; 0.9; 1" keySplines=".17 .67 .83 .67; .17 .67 .83 .67; .17 .67 .83 .67; .17 .67 .83 .67; .17 .67 .83 .67; .17 .67 .83 .67; .17 .67 .83 .67" calcMode="spline"/>
                            <g transform="translate(-900, -520)">
                                <g>
                                    <g id="Layer_1">
